...
import { Modal, Menu, Icon, Tabs, message, Form, Input, Button, Checkbox } from 'antd';
                            ...
                            <Tabs type="card" onChange={this.callback.bind(this)}>
                                ...
                                <TabPane tab="注册" key="2">
                                    <Form layout="horizontal" onSubmit={this.handleSubmit.bind(this)}>
                                        ...
                                        <FormItem label="确认密码">
                                            <Input type="password" placeholder="请确认你的密码" {...getFieldProps('r_confirmPassword') } />
                                        </FormItem>
